...
export const ExclusiveDeals = () => {
  return (
    <section className="flex flex-col lg:flex-row items-center gap-y-6 lg:gap-x-10 max-w-7xl my-10 mx-4 lg:mx-auto bg-[#F8F3F0]">
      <div className="flex flex-col gap-y-6 lg:pl-24">
